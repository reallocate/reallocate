...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'website_project_sites')
        ...
        # Adding M2M table for field sites on 'Opportunity'
        m2m_table_name = db.shorten_name(u'website_opportunity_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('opportunity', models.ForeignKey(orm[u'website.opportunity'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['opportunity_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'Project'
        db.delete_table(db.shorten_name(u'website_project_sites'))

        # Removing M2M table for field sites on 'Opportunity'
        db.delete_table(db.shorten_name(u'website_opportunity_sites'))
