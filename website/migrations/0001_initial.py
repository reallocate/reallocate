...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_project', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('cause', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('media_url', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('video_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'website', ['Project'])

        # Adding M2M table for field followed_by on 'Project'
        m2m_table_name = db.shorten_name(u'website_project_followed_by')
        ...
        db.create_table(u'website_userprofile', (
            ...
            ('causes', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('skills', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'website_project_followed_by'))
