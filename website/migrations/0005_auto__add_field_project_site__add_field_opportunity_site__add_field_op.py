...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_project', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Opportunity.site'
        db.add_column(u'website_opportunity', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'OpportunityEngagement.site'
        db.add_column(u'website_opportunityengagement', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'UserProfile.site'
        db.add_column(u'website_userprofile', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Organization.site'
        db.add_column(u'website_organization', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Update.site'
        db.add_column(u'website_update', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'website_project', 'site_id')

        # Deleting field 'Opportunity.site'
        db.delete_column(u'website_opportunity', 'site_id')

        # Deleting field 'OpportunityEngagement.site'
        db.delete_column(u'website_opportunityengagement', 'site_id')

        # Deleting field 'UserProfile.site'
        db.delete_column(u'website_userprofile', 'site_id')

        # Deleting field 'Organization.site'
        db.delete_column(u'website_organization', 'site_id')

        # Deleting field 'Update.site'
        db.delete_column(u'website_update', 'site_id')
